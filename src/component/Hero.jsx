...
const Hero = () => {
  ...
  return (
    <div id='home' className="w-screen h-screen relative overflow-hidden bg-black">
      ...
      /> */}
      <img
        src='https://images.unsplash.com/photo-1510915228340-29c85a43dcfe?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
        className="absolute inset-0 opacity-100 w-full h-full object-cover"
        alt=""
      />

      <div className="relative h-full px-4 mx-auto">
        <div className="absolute inset-0 top-3/9  flex flex-col items-center gap-0 md:gap-4 text-white">
          ...
          <div className="mt-4 flex items-center gap-6">
            ...
            }} className="px-4 sm:px-8 py-2 bg-amber-500 font-medium text-[14px] rounded-full">
              Download CV
            </button>
