      ...
      <div className='max-w-7xl px-4 py-16 mx-auto'>
        <div>
          ...
          <Marquee
            ...
            play={true}
          >
            <div className='py-10 mx-auto flex justify-between gap-8 md:gap-16'>
              {
                tool.map((item, idx) => {
                  return (
                    <div key={idx} className={`flex flex-col items-center gap-1`}>
                      <span className="w-10 md:w-12 lg:w-18  h-10 md:h-12 lg:h-16">
                        {item.icon}
                      </span>
          ...
          <Marquee
            ...
            play={true}
          >
            <div className='mt-8 py-10 mx-auto flex justify-between gap-8 md:gap-16'>
              {
                skill.map((item, idx) => {
                  return (
                    <div key={idx} className={`flex flex-col items-center`}>
                      <span className="w-10 md:w-12 lg:w-16  h-10 md:h-12 lg:h-16">
                        {item.icon}
                      </span>
                      <p className='font-medium'>{item.label}</p>
                    </div>
